...
use Container\Reference\ParameterReference;
use Container\Reference\ServiceReference;
    ...
    private function resolveArguments(array $argumentDefinitions)
    {
        ...
        foreach ($argumentDefinitions as $argumentDefinition) {
            if ($argumentDefinition instanceof ServiceReference) {
                ...
                $parameter = $this->getParameter($argumentParameterName);

                if (is_object($parameter)) {
                    array_merge($arguments, $this->resolveArguments([$parameter]));
                    // @todo to chech how it works with PdoStorage
                } else {
                    $arguments[] = $parameter;
                }
            } else {
